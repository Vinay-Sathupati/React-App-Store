...
class AppStore extends Component {
  ...
  onChangeTab = tabId => {
    const getActiveTab = tabsList.find(eachTab => eachTab.tabId === tabId)

    this.setState({activeTabId: getActiveTab.tabId})
  }
  ...
  render() {
    ...
    const filteredTabApps = this.activeTabApps(activeTabId)

    const searchedApps = filteredTabApps.filter(eachapp =>
    ...
    return (
      <div className="bg-contanier">
        <div className="app-store">
          ...
          <ul className="app-item-unordered-list">
